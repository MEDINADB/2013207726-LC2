...
namespace PaqueteTuristico.MVC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonaId,Nombres,ApellidoPaterno,ApellidoMaterno,Correo,Telefono,Dirección,NumeroDni,NumeroCuenta")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonaId,Nombres,ApellidoPaterno,ApellidoMaterno,Correo,Telefono,Dirección,NumeroDni,NumeroCuenta")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
