...
namespace PaqueteTuristico.MVC.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonaId,Nombres,ApellidoPaterno,ApellidoMaterno,Correo,Telefono,Dirección,NumeroDni,EmpleadoSueldo")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonaId,Nombres,ApellidoPaterno,ApellidoMaterno,Correo,Telefono,Dirección,NumeroDni,EmpleadoSueldo")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
